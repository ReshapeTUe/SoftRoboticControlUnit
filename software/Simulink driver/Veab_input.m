classdef Veab_input < realtime.internal.SourceSampleTime & ...
    ...
    methods
        % Constructor
        function obj = Veab_input(varargin)
    ...
    methods (Access=protected)
        ...
        function y = stepImpl(obj)   %#ok<MANU>
            ...
            if isempty(coder.target)
                ...
                s = coder.ceval('getVeab', cast(obj.i2cbus,"uint8"), cast(obj.channel,"uint8"), double(obj.resolution))
                %disp(s)
                %s = coder.ceval('test_f');
                y =  cast(s,"double") / 1000;
            end
        end
